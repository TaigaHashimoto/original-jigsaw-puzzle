            ...
            for _ in 0..<answerAreaAray.count {
                ...
                if (answerView.frame.contains(targetImg.center)) {
                    ...
                    if correctCount == 9 {
                        ...
                        // トリミング
                        trimImage = trimmingImage(capturedImage!, trimmingArea: CGRect(x: self.baseImg.center.x*2 - self.beforeImg.center.x*2, y: self.baseImg.center.y*2 - self.beforeImg.center.y*2, width: beforeImg.frame.width*2, height: beforeImg.frame.width*2))
...
extension _ViewController: UIViewControllerTransitioningDelegate {
